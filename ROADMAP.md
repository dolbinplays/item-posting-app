...
- Sold and shipped workflow with profit, fee, and shipping tracking. Sale/profit tracking foundation, fulfillment fields, dedicated sales CSV export, printable sold-items report, local dashboard with marketplace and monthly totals plus direct item links, needs-fulfillment filters, and workstation quick fulfillment actions with sale-price backfill implemented; future work can add richer profit charts.
