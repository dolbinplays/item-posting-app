...
- Archive dry-run export produces a reviewable, no-data-changes plan showing which items would be eligible for future local media compaction, what would be kept, what could be removed or shrunk, and which blockers prevent archiving. Implemented.
