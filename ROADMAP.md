...
- Archive-readiness signal identifies which items already have enough Google Drive/Sheet coverage to become candidates for future lighter local records or native-storage archival. It reports counts and top ready/not-ready items only; it does not delete or compact item records yet. Implemented.
