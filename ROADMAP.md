...
- Android APK wrapper with Bubblewrap, production PNG icons, signing key, and ready-to-publish Digital Asset Links association. First signed APK and App Bundle generated locally; domain-root association hosting and phone test remain.
